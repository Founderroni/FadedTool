...
namespace FadedTool
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
			...
			//Variables
			string supportsVersionsList = "1.16.40 | 1.16.100 | 1.16.201 | 1.16.210 | 1.16.221 | 1.17.0 | 1.17.2 | 1.17.10/1.17.11 | 1.17.40 | 1.17.41 | 1.18.0 | 1.18.2";
			...
			while (true)
			{
				try
				{
					...
					else if (gameVersionSelected == "10" || gameVersionSelected == "1.17.41")
					{
						gameVersionAddress = "041F4318,0,20,0";//1.17.41
					}
					else if (gameVersionSelected == "11" || gameVersionSelected == "1.18.0")
					{
						gameVersionAddress = "04215D08,0,20,0";//1.18.0
					}
					else if (gameVersionSelected == "12" || gameVersionSelected == "1.18.2")
					{
						gameVersionAddress = "0421B218,0,20,0";//1.18.2
					}
					else if (gameVersionSelected == "m" || gameVersionSelected == "manual" || gameVersionSelected == "f")
					{
						gameVersionAddress = "0421B218,0,20,0";//1.18.2
						ChangeDidRandom();
						Console.ReadKey();
